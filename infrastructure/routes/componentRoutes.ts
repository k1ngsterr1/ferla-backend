...
router.get("/get-components", (req, res) => componentController.getComponents(req, res));

router.delete("/delete/:id", (req, res) => componentController.deleteComponent(req, res));
